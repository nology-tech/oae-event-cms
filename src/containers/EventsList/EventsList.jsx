  ...
  return (
    <div className="event-list">
      ...
      <div className="event-list__UI">
        ...
        <Link to="/create/event" alt="link to edit/create event page" title="Link to edit/create event page"><Button buttonText="Add +" buttonType="primary" alt="Button to take you to create event page"/></Link>
