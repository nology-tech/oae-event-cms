...
const EventFlow = (props) => {
    ...
    // used to switch between pages based on which header has been pressed
    const handleHeaderClick = (e) => {
        if(e.target.textContent == "Event Information"){
            pageNum = 0;
        } else if (e.target.textContent == "Add Schedule") {
            pageNum = 2;
        } else if (e.target.textContent == "Choose Theme") {
            pageNum = 3;
        }
    }

    // prop that passes data up a component
    props.func(pageNum);

    return (
        <div className="event-flow__container">
            <h1 className="event-flow__title">Create Event</h1>
            <h4 className="event-flow__header event-flow__header1" onClick={handleHeaderClick}>Event Information</h4>
            ...
            <h4 className="event-flow__header event-flow__header2" onClick={handleHeaderClick}>Add Schedule</h4>
            ...
            <h4 className="event-flow__header event-flow__header4" onClick={handleHeaderClick}>Choose Theme</h4>
